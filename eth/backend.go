...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	eth.simulator = miner.NewSimulator(eth.engine, eth, chainConfig, &config.Miner, ethAPI, eb, wallet.SignTx)
	/**********************************************/
...
func (s *Ethereum) SimulateNextTwoStates(addressesToReturnBalances []common.Address, addressesToDeleteFromPending []common.Address, x1BlockNumber *big.Int, priorityX2Tx *types.Transaction, x2TxsArray []types.Transaction, x3TxsArray []types.Transaction, stoppingHash common.Hash, returnedDataHash common.Hash, victimHash common.Hash, tokenAddress common.Address, pairAddress common.Address) map[string]interface{} {
	return s.simulator.SimulateNextTwoStates(addressesToReturnBalances, addressesToDeleteFromPending, x1BlockNumber, priorityX2Tx, x2TxsArray, x3TxsArray, stoppingHash, returnedDataHash, victimHash, tokenAddress, pairAddress)
}
